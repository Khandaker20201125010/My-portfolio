    ...
    <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
      <div className="navbar bg-transparent">
        <div className="navbar-start fixed z-30">
          ...
          {/* Menu Items */}
          <div
            className={`fixed top-0 left-0 w-[550px] h-full bg-base-200 transition-transform duration-500 ease-in-out z-50 ${
        ...
        <div className="navbar-end w-full max-sm:hidden ">
          <div className="flex ">
          ...
          >
            ...
            <span
              className={`block transition-opacity duration-300 ease-in-out ${
                showKhandaker ? "opacity-0" : "opacity-100"
              }`}
            >
              K.I.H
            </span>
            ...
            <span
              className={`absolute top-0 left-0 transition-opacity duration-300 ease-in-out ${
                showKhandaker
                  ? "opacity-100 animate__animated animate__fadeInRight"
                  : "opacity-0"
              }`}
            >
